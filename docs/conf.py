...
"""
# FauxFactory documentation build configuration file, created by
# sphinx-quickstart on Wed Apr 16 15:46:04 2014.
#
...
# Intersphinx mapping to link to Python standard library documentation
intersphinx_mapping = {
...
project = "FauxFactory"
copyright = "2014-2025, Og Maciel"  # pylint:disable=redefined-builtin
...
nitpick_ignore = [
    ...
    ("py:class", "str"),
    ("py:class", "tuple"),
    # TypeVars and internal types
    ("py:class", "fauxfactory.factories.choices.T"),
    ("py:class", "fauxfactory.helpers.F"),
    # Pattern type from re module
    ("py:class", "re.Pattern"),
]
